...
// Dialog Data
	...
	BOOL	m_bTitanDistributor;
	BOOL	m_bDeuteriumDistributor;
	BOOL	m_bDuraniumDistributor;
	BOOL	m_bCrystalDistributor;
	BOOL	m_bIridiumDistributor;
	BOOL	m_bDeritiumDistributor;
