...
void CPrerequisitesDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_NEEDEDSYSTEMS, m_iNeededSystems);
	DDV_MinMaxUInt(pDX, m_iNeededSystems, 0, 255);
...
{	
	...
	m_iNeededSystems = building->GetNeededSystems();
...
void CPrerequisitesDlg::DialogToData(CBuildingInfo* building, int language)
{
	...
	*/
	...
	building->SetNeededSystems(m_iNeededSystems);
