...
public:
	...
	// neu für Alpha5
	BOOLEAN* GetDistributedRes() {return m_bDistributeRes;}
	USHORT GetNeededSystems() const {return m_iNeededSystems;}
...
protected:
	...
	// neu für Alpha5
	BOOLEAN m_bDistributeRes[FOOD + 1];			///< Ressourcenverteiler
	USHORT m_iNeededSystems;					///< minimal benötigte Systeme um Gebäude bauen zu können
