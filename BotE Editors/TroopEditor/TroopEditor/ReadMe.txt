================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: TroopEditor-Projektübersicht
===============================================================================

Der Anwendungs-Assistent hat diese TroopEditor-Anwendung für Sie 
...
finden, aus denen Ihre TroopEditor–Anwendung besteht.
...
TroopEditor.h
    ...
    die CTroopEditorApp-Anwendungsklasse.

TroopEditor.cpp
    Dies ist die Hauptquelldatei der Anwendung, die die CTroopEditorApp-
...
res\TroopEditor.ico
    ...
    Dieses Symbol ist in der Hauptressourcendatei "TroopEditor.rc" 
    enthalten.
...
TroopEditorDlg.h, TroopEditorDlg.cpp – das Dialogfeld
    Diese Dateien enthalten Ihre CTroopEditorDlg–Klasse. Diese Klasse 
    bestimmt das Verhalten des Hauptdialogfelds Ihrer Anwendung. Die Vorlage des 
    Dialogfelds befindet sich in der Datei "TroopEditor.rc", die in 
...
"StdAfx.h", "StdAfx.cpp"
    ...
    (PCH-Datei) mit dem Namen "TroopEditor.pch.pch2 und eine 
