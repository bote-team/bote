...
#define HANDSHAKE_TIMEOUT		10 //5						///< in Sekunden
...
#define RECEIVE_TIMEOUT			10 // 5						///< Timeout beim Empfangen von Daten (s)
#define SEND_TIMEOUT			16 // 8						///< Timeout beim Senden von Daten (s)
